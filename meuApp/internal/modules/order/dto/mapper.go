...
// ToPaginatedOrderResponse converte resultado paginado para PaginatedOrderResponse
func ToPaginatedOrderResponse(result *ports.PaginatedOrderResult) *PaginatedOrderResponse {
	orderResponses := make([]OrderResponse, len(result.Items))
